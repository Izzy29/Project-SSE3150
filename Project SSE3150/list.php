                ...
                if ($result = $pdo->prepare($sql)) {
                    ...
                    if ($result->rowCount() > 0) {
                        ...
                        while ($row = $result->fetch()) {
                            ...
                            echo "<td>";
                            echo '<a href="section1.php?projectID=' . $row['projectId'] . '" class="mr-5" title="Answer the assessment" data-toggle="tooltip"><span class="fa fa-book"></span></a>';
                            echo '<a href="displayResult.php?projectID=' . $row['projectId'] . '" class="mr-5" title="View Result" data-toggle="tooltip"><span class="fa fa-bar-chart"></span></a>';
